window.MagicOrders =
  ...
  init: ->
    ...
    @trade_pops = {
      ...
      #trade_mode
      'trades':                  ['deliver', 'logistic_waybill', 'confirm_receive', 'logistic_memo', 'detail', 'seller', 'cs_memo', 'color', 'invoice', 'trade_split', 'recover', 'mark_unusual_state', 'reassign', 'request_return', 'confirm_return', 'confirm_refund', 'check_goods', 'deliver', 'seller_confirm_deliver', 'seller_confirm_invoice', 'barcode', 'check_goods', 'logistic_split', 'print_logistic_bill', 'print_deliver_bill', 'confirm_refund', 'operation_log', 'manual_sms_or_email','confirm_color','confirm_check_goods', 'logistic_waybill', 'gift_memo', 'modify_payment'],
