...
class Account < ActiveRecord::Base
  ...
  def setting_values
    [
      ...
      ["stock_in_bill_visible_cols", ["tid",
                                  "status",
                                  "operation",
                                  "stock_type_name",
                                  ...
                                  "bill_products_price"]],
      ["stock_out_bill_cols", {"tid" => "出库单编号",
          "status" => "当前状态",
          "operation" => "历史状态",
          "stock_type_name" => "出库类型",
          "bill_products_mumber" => "商品数量",
          "bill_products_price" => "商品总价"}],
      ["stock_out_bill_visible_cols", ["tid",
                                  "status",
                                  "operation",
                                  "stock_type_name",
                                  "bill_products_mumber",
                                  "bill_products_price"]],
      ["stock_bill_cols", {"tid" => "出/入库单编号",
          "status_text" => "状态",
          "product_sku" => "商品编码",
          "product_title" => "商品名称",
          "stock_type_name" => "类型",
