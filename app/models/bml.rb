...
class Bml
  def self.search_order_status(tid)
    client = Savon.client(wsdl: $biaogan_client)
      response = client.call(:search_order_status) do
        message CustomerId: $biaogan_customer_id, PWD: $biaogan_customer_password, orderId: tid
      end
  ...
  def self.stock_query_by_sku(sku)
    ...
    response = client.call(:stock_query_by_sku) do
      message CustomerId: $biaogan_customer_id, PWD: $biaogan_customer_password, SKU: sku
    end
  ...
  def self.order_detail_query_today
    ...
    response = client.call(:order_detail_query_today) do
      message CustomerId: $biaogan_customer_id, PWD: $biaogan_customer_password
    end
  ...
  def self.order_detail_query_by_id(orderId)
    ...
    response = client.call(:order_detail_query_by_id) do
      message CustomerId: $biaogan_customer_id, PWD: $biaogan_customer_password, OrderId: orderId
    end
  ...
  def self.shipment_info_query_by_date(date)
    ...
    response = client.call(:shipment_info_query_by_date) do
      message CustomerId: $biaogan_customer_id, PWD: $biaogan_customer_password, Date:date
    end
