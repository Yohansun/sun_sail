...
class TradeJingdongDeliver
  ...
  def perform(id)
    ...
    response = JingdongFu.get method: '360buy.order.sop.outstorage', order_id: trade.tid,
      logistics_id: jingdong_logistics[trade.logistic_code || "OTHER"], waybill: trade.logistic_waybill,
      trade_no: trade.tid
