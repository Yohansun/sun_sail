...
class StockApiController < ApplicationController
  ...
  # response = client.call(:input_back, message:{login:"ALLYES", passwd:"BML33570",xml: xml})
  # response.body[:input_back_response][:value]

  #入库订单反馈
  def input_back
  	if params[:login] == "ALLYES" && params[:passwd] == "BML33570"
  ...
  # response = client.call(:output_back, message:{login:"ALLYES", passwd:"BML33570",xml: xml})
