...
describe TradeDecorator do
  ...
  describe "Taobaotrade" do
   context '#post_fee, point_fee, seller_discount, total_fee, sum_fee' do
    before do 
      @decorator = TradeDecorator.new(build(:taobao_trade, post_fee: 20, point_fee: 20, payment: 2000, total_fee: 3000, promotion_fee: 20.0))
    end
    ...
    it { @decorator.seller_discount == 20.0}
   end
  end
