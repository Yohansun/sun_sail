# -*- encoding:utf-8 -*-
task :export_taobao_trade_report_with_tids => :environment do
  ...
  tids = ["433324669690047", "433292736140047", "436079080540611", "438317938504398", "436390124946519", "437911078712268", "437954891198570"]
  trades = Trade.any_in(tid: tids)
  row_number = 1
  ...
  file = "#{Rails.root}/taobao_trade_report_with_tids.xls"
  book.write file
end